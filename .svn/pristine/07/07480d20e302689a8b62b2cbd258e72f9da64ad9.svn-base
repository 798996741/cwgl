...
<div id="mask" class="mask">
    <div id="darkmask" class="darkmask">
        <div class="mask-top">
            <span class="mask-top-size" style="letter-spacing: 3px;"><b>收票明细</b></span>
                ...
                <form name="form_add3" id="form_add3">
                    ...
                    <div class="between-center">
                        <div class="between-center padding-8px">
                            <span class="mask-size">收票时间</span>
                  ...
                  padding-left: 5px;" autoComplete="off" />
                        ...
                        <div class="between-center padding-8px">
                            <span class="mask-size">收票金额</span>
                    ...
                    <form name="form_add2" id="form_add2">
                        <table border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                ...
                                <th class="center">收票金额</th>
                                <th class="center">收票内容</th>
                                <th class="center">收票税率</th>
...
<script type="text/javascript">
    ...
    function del(invmid) {
        if (confirm("确定要删除吗?")) {
            ...
            var url = "<%=basePath%>purchase/deleteInvmon.do?invmid=" + invmid;
            $.ajax({
                type: 'post',
                data: { invmid: invmid },
                url: url,
