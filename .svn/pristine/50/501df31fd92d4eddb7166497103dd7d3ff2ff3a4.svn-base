                            ...
                            <div id="zhongxin" style="padding-top: 13px;">
                                <table id="table_report" class="table table-striped table-bordered table-hover">
                                    <tr>
                                        ...
                                        <td><input type="text" name="NAME" id="NAME" value="${pd.NAME}" maxlength="30"
                                                   placeholder="这里输入名称" title="名称" style="width:98%;"/></td>
                                    </tr>
                                    <tr>
                                        <td style="width:79px;text-align: right;padding-top: 13px;">权限标识:</td>
                                        <td><input oninput="changecode(this.value)" type="text" name="QX_NAME"
                                                   id="QX_NAME" value="${pd.QX_NAME}" maxlength="50"
                                                   placeholder="这里输入权限标识" title="权限标识" style="width:98%;"/></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td style="width:78px;height:130px;text-align: right;padding-top: 13px;">代码:
                                        </td>
                                        <td>
                                            <textarea rows="5" cols="10" id="code" style="width:98%;"
                                                      readonly="readonly" title="代码区,禁止手动输入"></textarea>
                                        </td>
                                    </tr>
                                    <tr>
