...
public class SellServiceImpl implements SellService{
    ...
    public void updateInvmonById(tbinvmon invmon) throws Exception {
        sellDao.update("SellMapper.updateInvmonById",invmon);
    }
    ...
    public List<PageData> conWord(PageData pd) throws Exception {
        return (List<PageData>) sellDao.findForList("SellMapper.conWord",pd);
    }

    @Override
    public List<PageData> clinoWord(PageData pd) throws Exception {
        return (List<PageData>) sellDao.findForList("SellMapper.clinoWord",pd);
    }

    @Override
    public List<PageData> supnoWord(PageData pd) throws Exception {
        return (List<PageData>) sellDao.findForList("SellMapper.supnoWord",pd);
    }
