  ...
  <div class="content-wrapper" style="width:100%;margin-left:0px;">
    <section class="container-fluid">
      ...
      <div class="seat-middle">
        ...
        <div class="seat-middle-r zxzgl-middle-r">
          <!-- <div class="box-body" > -->
                      ...
                      <tr>
                        ...
                        <td class="center" style="width: 50px;">
                          ...
                          <div class="hidden-sm hidden-xs btn-group">
                            ...
                            <c:if test="${QX.del == 1 }">
                              <a style="margin-left:10px;" class="cy_sc" onclick="del('${var.FHLOG_ID}');"> <i
                                  title="删除"></i>
                              </a>
                            </c:if>
                          </div>
                          <div class="hidden-md hidden-lg">
                            <div class="inline pos-rel">
                              ...
                              <ul
                                ...
                                <c:if test="${QX.del == 1 }">
                                  <a style="margin-left:10px;" class="cy_sc" onclick="del('${var.ID}');"> <i
                                      title="删除"></i>
                                  </a>
                                </c:if>
                              </ul>
