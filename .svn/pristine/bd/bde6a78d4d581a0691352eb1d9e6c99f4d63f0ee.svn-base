package com.fh.utils.fileupload;
import java.io.File;
...
public class z_UploadUtils {
    ...
    public String[] uploadFile(HttpServletRequest request) {
        ...
        // 上传
        List<FileItem> fiList = (List<FileItem>) fieldsMap.get(z_UploadUtils.FILE_FIELDS);
        if (fiList != null) {
