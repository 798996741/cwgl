                ...
                <form name="form_add" id="form_add">
                  ...
                  <span class="mask-size flex-row-between">
                    <font style="color: red;">*</font>签订时间
                            ...
                            <input class="date-picker" name="signtime" id="signtime" autoComplete="off"
                                   value="${sign.signtime }" type="text" data-date-format="yyyy-mm-dd"
                                   onchange="combo()"
                                   style="width: 136px;
                  height: 28px;
                  line-height: 28px;
                  ...
                  <span class="mask-size flex-row-between">
                    <font style="color: red;">*</font>项目/<br/>产品类型
                            ...
                            <select class="js-example-basic-single mask-select" name="pno" id="pno"
                                    onchange="combo()">
                                <option value="" selected></option>
                  ...
                  <span class="mask-size flex-row-between">
                    <font style="color: red;">*</font>乙&nbsp;&nbsp;&nbsp;&nbsp;方
                            ...
                            <select class="js-example-basic-single mask-select"
                  ...
                  <span class="mask-size flex-row-between">
                    <font style="color: red;">*</font>归档情况
                            ...
                            <select class="mask-select" name="isarc" id="isarc1">
                                <option value="" selected></option>
                                <option value="0"
                  ...
                  <span class="mask-size">
                    <font style="color: red;">*</font>合同总金额
                        ...
                        <div class="between-center padding-8px"
                            ...
                            <select class="mask-select" name="state" id="state1">
                                <option value="2"
                            ...
                            <div class="between-center padding-8px">
                                ...
                                <div class="mask-input center-center bgcolor-rgba" style="background-color: #eef2f5;">
                                    ...
                                    <div class="mask-edit mask-img" href="javascript:void (0)"
                                         style="margin-left: -60px;" onclick="editContmon('${sign.conid}');">
                        ...
                        <div class="between-center">
                            <div class="between-center padding-8px">
                                ...
                                <div class="mask-input center-center bgcolor-rgba" style="background-color: #eef2f5;">
                                    ...
                                    <div class="mask-edit mask-img" style="margin-left: -60px;"
                                         href="javascript:void (0)" onclick="editInvmon('${sign.conid}');">
                                        <font class="mask-img-size">编辑</font>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="between-start">
                        ...
                        <div class="between-start padding-8px" style="position:relative;">
                            ...
                            <textarea class="mask-textarea mask-textarea4 " name="busiexp"
                        ...
                        <div class="between-center">
                            <div class="between-center padding-8px">
                                ...
                                <div class="mask-input center-center bgcolor-rgba" style="background-color: #eef2f5;">
                                    ...
                                    <div class="mask-edit mask-img" href="javascript:void (0)"
                                         style="margin-left: -60px;" onclick="editBusimon('${sign.conid}');">
                                        <font class="mask-img-size">编辑</font>
                                    </div>
                                </div>
                            </div>
