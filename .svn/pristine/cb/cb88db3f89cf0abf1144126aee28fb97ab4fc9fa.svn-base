...
public class SupplierController extends BaseController {
    ...
    @RequestMapping(value = "/getbysupfname.do")
    @ResponseBody
    public Object getBySupfname(String supfname) throws Exception {

        PageData pd = this.getPageData();
        pd = this.getPageData();
        pd.put("supfname",supfname);
        PageData bySupfname = supplierService.getBySupfname(pd);
        String supid = bySupfname.get("supid").toString();
        pd.put("supid",supid);
        PageData byId = supplierService.findById(pd);
        System.out.println(byId);
        JSONObject jsonObject = new JSONObject();
        jsonObject.put("bySupfname",byId);
