                            ...
                            <form action="user/listUsersForWindow.do" method="post" name="userForm" id="userForm">
                                <table style="margin-top:5px;">
									...
									<span class="input-icon">
                                        ...
                                        <td style="padding-left:2px;"><input class="span10 date-picker"
                                                                             name="lastLoginEnd" name="lastLoginEnd"
                                        ...
                                        <td style="vertical-align:top;padding-left:2px;">
                                            <select class="chosen-select form-control" name="ROLE_ID" id="role_id"
                                                    data-placeholder="请选择角色" style="vertical-align:top;width: 120px;">
                                                <option value=""></option>
                                                ...
                                                <c:forEach items="${userList}" var="user" varStatus="vs">
                                                    <tr>
                                                        <td class='center' style="width: 30px;">
                                                            <label><input type='radio' name="fhadmin"
                                                                          value="${user.USERNAME }"
                                                                          onclick="setUser(this.value)"
