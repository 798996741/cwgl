        ...
        <div class="page-content">
          <div class="row">
            <div class="col-xs-12">
                            ...
                            <div class="hidden-md hidden-lg">
                              <div class="inline pos-rel">
                                ...
                                <ul
                                  ...
                                  <c:if test="${QX.edit == 1 }">
                                    <li><a href="javascript:editTb('${menu.MENU_ID }');" class="tooltip-info"
                                        data-rel="tooltip" title="View">
                                        <span class="blue">
                                          <i class="ace-icon glyphicon glyphicon-picture bigger-120" title="编辑图标"></i>
                                        </span>
                                      </a></li>
                                    <li><a href="javascript:editmenu('${menu.MENU_ID }');" class="tooltip-success"
                                  ...
                                  <c:if test="${QX.del == 1 }">
                                    <li><a href="javascript:delmenu('${menu.MENU_ID }');" class="tooltip-error"
              ...
              <div>
                &nbsp;&nbsp;
                <c:if test="${QX.add == 1 }"><a class="btn btn-sm btn-success" onclick="addmenu('${MENU_ID}');">新增</a>
                </c:if>
