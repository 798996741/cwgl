...
public class RoleController extends BaseController {
	...
	public ModelAndView add()throws Exception{
		...
		try{
			...
			System.out.println("pd.getString(\"PARENT_ID\"):"+pd.getString("PARENT_ID"));
			String parent_id = pd.getString("PARENT_ID")==""?"0":pd.getString("PARENT_ID");		//父类角色id
	...
	public ModelAndView listAllMenu(Model model,String ROLE_ID)throws Exception{
		...
		try{
			...
			System.out.println(role.getMENU_IDS()+"role.getMENU_IDS()+++++");
