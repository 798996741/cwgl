                ...
                <form name="form_add3" id="form_add3">
                    ...
                    <div class="between-center">
                        <div class="between-center padding-8px">
                            <span class="mask-size">付款时间</span>
                            <input class="date-picker" name="paytime" id="paytime" value="" type="text"
                  ...
                  padding-left: 5px;" autoComplete="off" />
                        ...
                        <div class="between-center padding-8px">
                            <span class="mask-size">付款金额</span>
                            <input type="text" name="paymon" id="paymon" placeholder="这里输入收款金额" maxlength="64" title="收款金额"
                                    ...
                                    <c:forEach items="${clist}" var="clist" varStatus="vs">
                                        ...
                                        <tr>
                                            ...
                                            <td align="center">
                                                        ...
                                                        <%--</c:if>--%>&nbsp;&nbsp;&nbsp;&nbsp;
                                                        <%--<c:if test="${QX.del == 1 }">--%>
                                                    <i><img src="static/img/home/delete.png" onclick="delc('${clist.conmid}');"
                                                            style="width:59px;height:25px"></i>
                                                            <%--<div class="mask-delete mask-img" href="javascript:void (0)"--%>
                                                                 <%--onclick="delc('${clist.conmid}');">--%>
