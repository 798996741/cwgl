...
<%--                </div>--%>
  ...
  height: 21px;">
    ...
    background: #4b9dd7;
    padding: 5px;">
                            <th class="center" style="color: #ffffff;">公司名称</th>
...
<script type="text/javascript">
    ...
    function toExcelstat() {
        ...
        var time1 = $("#time1").val();
        var time2 = $("#time2").val();
        window.location.href = "<%=basePath%>reimdet/exportCsnameReimstat.do?time1=" + encodeURI(encodeURI(time1)) +
    ...
    function toperson() {
        ...
        var time1 = $("#time1").val();
        var time2 = $("#time2").val();
        window.location.href = "<%=basePath%>reimdet/getProce_reim.do?time1=" + encodeURI(encodeURI(time1)) +
            "&time2=" + encodeURI(encodeURI(time2));
    }
    ...
    function tosearch() {
        ...
        //     var invnmon = "";
        // }
        location.href = "reimdet/getCsname_reim.do?time1=" + encodeURI(encodeURI(time1)) +
            "&time2=" + encodeURI(encodeURI(time2));
        //$("#Form_s").submit();
    }
