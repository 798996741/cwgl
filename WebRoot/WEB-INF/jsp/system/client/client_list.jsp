  ...
  <div class="content-wrapper" style="width:100%;margin-left:0px;">
    ...
    <section class="content container-fluid">
      <div class="seat-middle-top">
        <div class="seat-top">
          <div class="seat-subtitle">客户管理</div>
      ...
      <div class="seat-middle">
        ...
        padding: 5px">${vs.count}</td>
                      <td>${cList.csname}</td>
                      <td>${cList.clifname}</td>
                      <td>${cList.clisname}</td>
                      <td>${cList.clino}</td>
                      <td class="ticketInfo">
                        公司名称:${cList.tname}<br>
                        纳税人识别号: ${cList.taxno}<br>
                        地址、电话: ${cList.address}${cList.tel}<br>
                        开户行:${cList.bankname}<br>
                        账号:${cList.bankno}
                      </td>
...
<%--                        </img>--%>
                      ...
                      <td align="center">
                        <div class="flex-row-center">
                          ...
                          <%--<c:if test="${QX.edit == 1 }">--%>
<%--                          <img class="cy_bj" src="static/img/home/edit.png" style="width: 59px;height: 25px;"--%>
<%--                            onclick="editClient('${cList.cliid}');">--%>
<%--                          <i title="编辑"></i>--%>
<%--                          </img>--%>
...
<%--                          </img>--%>
  ...
  <script type="text/javascript">
    ...
    //删除
    function delclient(cliid) {
      if (confirm("确定要删除吗?")) {

        var url = "<%=basePath%>client/deleteClientById.do?cliid=" + cliid;
    ...
    function editClient(client_id) {
      ...
      modals.openWin({
        ...
        width: '900px',
          backdrop: 'static',
          keyboard: false,
        url: '<%=basePath%>client/findById.do?cliid=' + client_id
        /*, hideFunc:function(){
            modals.info("hide me");
        },
        showFunc:function(){
