...
<head>
    ...
    <script type="text/javascript" src="static/js/jquery.ztree-2.6.min.js"></script>
<body>
    ...
    <tr>
        ...
        <td style="width:85%;" valign="top">
            <iframe name="treeFrame" id="treeFrame" frameborder="0"
                    src="<%=basePath%>/dictionaries/list.do?DICTIONARIES_ID=${'' == DICTIONARIES_ID?'0':DICTIONARIES_ID}&currentPage=${null == pd.dnowPage || '' == pd.dnowPage?'10':pd.dnowPage}"
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        if ('${pd.DICTIONARIES_ID}' != "") {
            var node = zTree.getNodeByParam('id', '${pd.DICTIONARIES_ID}');//获取id为1的点
