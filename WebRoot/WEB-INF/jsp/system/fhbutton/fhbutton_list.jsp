                  ...
                  <tr>
                      ...
                      <div class="nav-search">
                        <span class="input-icon">
                          <input type="text" placeholder="这里输入关键词" class="nav-search-input" id="nav-search-input"
                            autocomplete="off" name="keywords" value="${pd.keywords }" placeholder="这里输入关键词" />
                    ...
                    <c:if test="${QX.cha == 1 }">
                      <td style="vertical-align:top;padding-left:2px"><a class="btn btn-light btn-xs"
                          onclick="tosearch();" title="检索"><i id="nav-search-icon"
                      ...
                      <c:when test="${not empty varList}">
                        <c:if test="${QX.cha == 1 }">
                          <c:forEach items="${varList}" var="var" varStatus="vs">
                            <tr>
                              <td class='center'>
                                <label class="pos-rel"><input type='checkbox' name='ids' value="${var.FHBUTTON_ID}"
                                ...
                                <div class="hidden-md hidden-lg">
                                  <div class="inline pos-rel">
                                    ...
                                    <ul
                                      ...
                                      <c:if test="${QX.edit == 1 }">
                                        <li>
                                          <a style="cursor:pointer;" onclick="edit('${var.FHBUTTON_ID}');"
                                      ...
                                      <c:if test="${QX.del == 1 }">
                                        <li>
                                          <a style="cursor:pointer;" onclick="del('${var.FHBUTTON_ID}');"
                  ...
                  <table style="width:100%;">
                    <tr>
                      <td style="vertical-align:top;">
                        ...
                        <c:if test="${QX.del == 1 }">
                          <a class="btn btn-sm btn-danger" onclick="makeAll('确定要删除选中的数据吗?');" title="批量删除"><i
