	            ...
	            <div class="username">
	                ...
	                <div class="user">
	                 ...
	                 <div class="saveUser">
	                    ...
	                    <div id="check">
                        <span><input type="checkbox" class="inputCheck" onclick="savePaw();" id="saveid">
							<label for="saveid"></label></span>
							<div class="selectUser">记住用户名</div>
                    </div>
	                </div> 
	                
	          

	            <div class="loginButton"><a href="javascript:void (0)" onclick="severCheck();" id="to-recover">登录</a> </div>
        	</div>
         </form>
    </div>
<%-- </div>
				...
				<div class="form-actions">
					<div style="width:86%;padding-left:8%;">
						...
						<div style="float: left;" class="codediv">
							<input type="text" name="code" id="code" value="6666" class="login_code"
			...
			<form action="" method="post" name="loginForm" id="loginForm">
				...
				<div class="form-actions">
					<div style="width:86%;padding-left:8%;">
						...
						<div style="float: left;" class="codediv">
							<input type="text" value="6666" name="rcode" id="rcode" class="login_code"
								style="height:16px; padding-top:4px;" />
						</div>
						<div style="float: left;">
