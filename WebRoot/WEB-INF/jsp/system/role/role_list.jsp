...
<body class="hold-transition skin-blue sidebar-mini">
  ...
  <div class="content-wrapper" style="width:100%;margin-left:0px;">
    <section class="content container-fluid">
      <div class="seat-top">
        <div class="seat-subtitle">角色</div>
        <c:if test="${QX.add == 1 }">
          <div class="seat-button">
            <a href="javascript:void (0)" onclick="addRole('${pd.parent_id}');">新增</a>
          </div>
        </c:if>
        <c:choose>
          ...
          <c:otherwise>
            <c:if test="${QX.edit == 1 }">
              <span style="float:left" onclick="editRights('${pd.ROLE_ID }');">
                ...
                <c:if test="${pd.ROLE_ID == '1'}">Admin权限</c:if>
                  ...
                  <c:if test="${QX.cha == 1 }">
                    <c:forEach items="${roleList_z}" var="var" varStatus="vs">
                      <tr>
                        ...
                        <td style="width:250px" id="ROLE_NAMETd${var.ROLE_ID }">${var.ROLE_NAME }</td>
                        <%--<c:if test="${QX.edit == 1 }">--%>
                          <%--<td style="width:30px;"><img src="static/img/home/setting_icon.png" width="20px" height="20px"--%>
                              <%--onclick="roleButton('${var.ROLE_ID }','add_qx');" href="javascript:void(0)"--%>
                              <%--title="分配新增权限"></img></td>--%>
                          <%--<td style="width:30px;"><img src="static/img/home/setting_icon.png" width="20px" height="20px"--%>
                              <%--onclick="roleButton('${var.ROLE_ID }','del_qx');" href="javascript:void(0)"--%>
                              <%--title="分配删除权限"></img></td>--%>
                          <%--<td style="width:30px;"><img src="static/img/home/setting_icon.png" width="20px" height="20px"--%>
                              <%--onclick="roleButton('${var.ROLE_ID }','edit_qx');" href="javascript:void(0)"--%>
                              <%--title="分配修改权限"></img></td>--%>
                          <%--<td style="width:30px;"><img src="static/img/home/setting_icon.png" width="20px" height="20px"--%>
                              <%--onclick="roleButton('${var.ROLE_ID }','cha_qx');" href="javascript:void(0)"--%>
                              <%--title="分配查看权限"></img></td>--%>
                        <%--</c:if>--%>
                        <td align="center">
                          <div class="flex-row-around">

                            <a class="btn btn-mini btn-danger" onclick="editRights('${var.ROLE_ID }');"><i
                                class="icon-pencil"></i>菜单权限</a>
                            <%--<a class="cy_bj" title="编辑" onclick="editRole('${var.ROLE_ID }');"><i></i></a>--%>
                          ...
                          <c:choose>
                            ...
                            <c:otherwise>
                                ...
                                <%--<a style="margin-left:10px;" class="cy_sc" title="删除"--%>
                                  <%--onclick="delRole('${var.ROLE_ID }','c','${var.ROLE_NAME }');"><i></i></a>--%>
