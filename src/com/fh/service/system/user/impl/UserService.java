...
public class UserService implements UserManager
{
	...
	@Override
	public List<PageData> getwxuser(PageData pd) throws Exception {
		return (List<PageData>) dao.findForList("UserMapper.getwxuser", pd);
	}
	...
	public List<PageData> listUsers(Page page)throws Exception{
		return (List<PageData>) dao.findForList("UserMapper.userlist", page);
	}
